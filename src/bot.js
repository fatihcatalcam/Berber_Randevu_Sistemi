...
const BERBERLER = [
  {
    ...
    fiyat: { sac: 150, sakal: 100, kombin: 220, cocuk: 100 },
  },
  {
    id: "mehmet",
    ad: "Mehmet Bey",
    uzmanlik: "Modern Kesim & Sakal",
    fiyat: { sac: 160, sakal: 110, kombin: 240, cocuk: 100 },
  },
  {
    id: "kemal",
    ad: "Kemal Usta",
    uzmanlik: "Fade & Tasarım",
    fiyat: { sac: 180, sakal: 120, kombin: 270, cocuk: 120 },
  },
];
...
// 09:00 - 17:30 arası 30 dakikalık aralıklar (18:00 dahil değil)
const SAATLER = (() => {
  const list = [];
